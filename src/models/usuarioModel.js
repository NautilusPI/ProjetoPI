...
function autenticar(email, senha) {
    ...
    var instrucaoSql = `
        SELECT idUsuario, Nome, Email, Senha, fkEmpresa AS idEmpresa FROM Usuario WHERE Email = '${email}' AND Senha = '${senha}';
    `;
...
function cadastrar(nome, email, cpf, senha, fkEmpresa) {
    ...
    var instrucaoSql = `
        INSERT INTO Usuario (Nome, Email, CPF, Senha, fkEmpresa) VALUES ('${nome}', '${email}', '${cpf}', '${senha}', ${fkEmpresa});
    `;
    console.log("Executando a instrução SQL: \n" + instrucaoSql);
    return database.executar(instrucaoSql);
}
